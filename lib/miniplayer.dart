...
class _MiniplayerState extends State<Miniplayer> with TickerProviderStateMixin {
                  ...
                  child: GestureDetector(
                    child: ValueListenableBuilder(
                      ...
                      builder:
                        ...
                        return Opacity(
                          opacity: borderDouble(
                              minRange: 0.0, maxRange: 1.0, value: 1.0 - value * 0.8),
                    ...
                    onPanEnd: (details) async {
                      ...
                      if (speed <= 4.0)
                        ...
                        snapPercentage = 0.08;
                      else if (speed <= 50.0) snapPercentage = 0.01;
                      ...
                      if (_startHeight > widget.minHeight) {
                        if (_percentageMax > 1.0 - snapPercentage)
                          snap = PanelState.MAX;
                      }
  ...
  void _handleHeightChange({bool animation = false}) {
    ...
    if (_dragHeight >= widget.minHeight) {
      if (dragDownPercentage.value != 0.0) dragDownPercentage.value = 0.0;
    ...
    ///Drag below minHeight
      ...
      var percentageDown = borderDouble(
          ...
          value: percentageFromValueInRange(
              min: widget.minHeight, max: 0.0, value: _dragHeight));

      if (dragDownPercentage.value != percentageDown)
        dragDownPercentage.value = percentageDown;

      if (percentageDown >= 1.0 && animation && !dismissed) {
